...
function checkType(typename, value) {
    return typeCheck(typename, value, {
        customTypes: {
            Vector2: {
                typeOf: 'Object',
...
/*
function checkClass(class_or_name, value) {
    if (typeof class_or_name === 'string') {
        return value.constructor && value.constructor.name && value.constructor.name === class_or_name;
    }
    return value instanceof class_or_name;
}
*/
function assertType(typename, value, msg) {
    if (!checkType(typename, value)) {
        throw new Error(msg || (value.toString() + ' is not of type ' + typename));
    }
}
/*
function assertClass(class_or_name, value) {
    if (!checkClass(class_or_name, value)) {
        throw new Error(value.toString() + ' is not instance of ' + typename);
    }
}*/

/**
* Usage:
* typeCheckedFn(['number', 'number'], function(a, b) { return a + b; })
*/
function typeCheckedFn(arg_types, fun) {
    return fun;
    return function() {
        for (var i = 0; i < arg_types.length; ++i) {
            assertType(arg_types[i], arguments[i]);
        }
